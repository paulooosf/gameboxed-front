  ...
  return (
    <div className="jogo">
        ...
        <div className="jogo__background">
            <img src={jogo.linkBanner} alt="Banner do jogo" className="jogo__background__imagem"/>
        </div>
        <article className="jogo__sobre">
            <aside className="jogo__sobre__capa">
                <img src={jogo.linkCapa} alt="Capa do jogo" className="jogo__sobre__capa__imagem"/>
            </aside>
            ...
            <section className="jogo__sobre__avaliacoes">
                <div className="jogo__sobre__avaliacoes__nota">
                    <p className="jogo__sobre__avaliacoes__nota__tipografia">{parseFloat(jogo.nota).toFixed(2)}</p>
        ...
        <article className="jogo__trailer">
            {jogo.linkTrailer && (
                <iframe width="589" height="431" src={converterLinkYoutube(jogo.linkTrailer)} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
            )}
        </article>
        <Footer/>
    </div>
