...
function Jogos() {
  ...
  return (
    <div className="jogos">
        <img src={Background} alt="Imagem de fundo do site, uma arte do jogo Valorant" className="jogos__background"/>
        ...
        <main className="jogos__resultado">
            ...
            <div className="jogos__paginas">
                ...
                <button
                    onClick={() => setPagina((anterior) => Math.min(anterior + 1, totalPaginas - 1))}
