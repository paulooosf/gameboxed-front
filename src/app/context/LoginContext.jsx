...
import { postLogin, postRegistrar, postSolicitarTokenSenha, postRedefinirSenha, sair } from "../../api/autenticacao";
...
export const LoginProvider = ({ children }) => {
    ...
    const solicitarTokenSenha = async (email) => {
        try {
            ...
            toast.error('Erro ao enviar e-mail, verifique se o e-mail existe e tente novamente.')
    ...
    const redefinirSenha = async (token, senha) => {
        try {
            ...
            toast.error('Erro ao redefinir senha, certifique-se que o token é válido e tente novamente.')
    ...
    return (
        <LoginContext.Provider value={{ logado, apelido, login, registrar, solicitarTokenSenha, redefinirSenha, logout }}>
            {children}
