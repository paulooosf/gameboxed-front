...
export const getAvaliacoes = async (pagina, tamanhoLista) => {
    const resposta = await axios.get(`${API_URL}/avaliacoes/lista?page=${pagina}&size=${tamanhoLista}`)
...
export const postAvaliacao = async (comentario, nota, idJogo) => {
    ...
    const resposta = await axios.post(`${API_URL}/avaliacoes`, {
        comentario,
        nota,
        idJogo
    }, {
...
export const putAvaliacao = async (id, comentario, nota, idJogo) => {
    ...
    const resposta = await axios.put(`${API_URL}/avaliacoes/editar?id=${id}`, {
        comentario,
        nota,
        idJogo
    }, {
...
export const deleteAvaliacao = async (id) => {
    ...
    const resposta = await axios.delete(`${API_URL}/avaliacoes/deletar?id=${id}`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    })
